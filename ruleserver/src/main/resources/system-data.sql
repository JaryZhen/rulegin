...
INSERT INTO rule ( id, name, plugin_token, state, search_text, weight, filters, processor, action )
VALUES ( '1e7461165abad4ca91992ebcb67fe33', 'System Telemetry Rule', 'telemetry', 'ACTIVE',
         ...
         null,
         '{"clazz":"org.thingsboard.server.extensions.core.actionsType.telemetry.TelemetryPluginAction", "name":"TelemetryMsgConverterAction", "configuration":{}}'
);

INSERT INTO plugin ( id, name, state, search_text, api_token, plugin_class, public_access, configuration )
VALUES ( '1e746116b3b8994a91992ebcb67fe33', 'System RPC Plugin', 'ACTIVE',
