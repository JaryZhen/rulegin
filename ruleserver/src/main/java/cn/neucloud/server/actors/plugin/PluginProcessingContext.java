...
import cn.neucloud.server.common.data.kv.*;
...
import cn.neucloud.server.common.data.id.*;
              ...
              /*      case ASSET:
                    ...
                    case CUSTOMER:
                        if (ctx.isSystemAdmin()) {
                            ...
                            ListenableFuture<User> customerFuture = (ListenableFuture<User>) pluginCtx.customerService.findUserCredentialsByUserId(new cn.neucloud.server.common.data.id.UserId(entityId.getId()));
