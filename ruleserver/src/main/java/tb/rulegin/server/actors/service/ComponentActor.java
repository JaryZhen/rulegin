...
import tb.rulegin.server.actors.stats.StatsPersistMsg;
...
import tb.rulegin.server.core.process.ComponentMsgProcessor;

import static tb.rulegin.server.common.data.component.ComponentLifecycleEvent.DELETED;
