...
import tb.rulegin.server.dao.util.mapping.JsonStringType;
...
import static tb.rulegin.server.common.data.UUIDConverter.fromString;
import static tb.rulegin.server.common.data.UUIDConverter.fromTimeUUID;
