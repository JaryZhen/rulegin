 ...
 */
package tb.rulegin.server.dao.timeseries;

import com.datastax.driver.core.ResultSet;
import com.datastax.driver.core.Row;
import lombok.extern.slf4j.Slf4j;
import tb.rulegin.server.common.data.kv.*;
...
public class AggregatePartitionsFunction implements com.google.common.base.Function<List<ResultSet>, Optional<TsKvEntry>> {
    ...
    public Optional<TsKvEntry> apply(@Nullable List<ResultSet> rsList) {
        try {
            log.trace("[{}][{}][{}] Going to aggregate dataSource", key, ts, aggregation);
            ...
            log.trace("[{}][{}][{}] Aggregated dataSource is empty.", key, ts, aggregation);
            return Optional.empty();
        }catch (Exception e){
            log.error("[{}][{}][{}] Failed to aggregate dataSource", key, ts, aggregation, e);
            return Optional.empty();
        }
    }
