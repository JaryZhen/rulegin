...
public class RuleController extends BaseController {
    ...
    @ResponseBody
    public UUID saveRule(@RequestBody RuleMetaData source) throws RuleginException {
        try {
    ...
    public void activateRuleById(@PathVariable("ruleId") String strRuleId) throws RuleginException {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void suspendRuleById(@PathVariable("ruleId") String strRuleId) throws RuleginException {
        checkParameter("ruleId", strRuleId);
        try {
            RuleId ruleId = new RuleId(toUUID(strRuleId));
            RuleMetaData rule = checkRule(ruleService.findRuleById(ruleId));
    ...
    @ResponseBody
    public RuleMetaData getRuleById(@PathVariable("ruleId") String strRuleId) throws RuleginException {
        checkParameter("ruleId", strRuleId);
        try {
            RuleId ruleId = new RuleId(toUUID(strRuleId));
    ...
    @ResponseBody
    public List<RuleMetaData> getRulesByPluginToken(@PathVariable("pluginToken") String pluginToken) throws RuleginException {
    ...
    public TextPageData<RuleMetaData> getSystemRules(
            ...
            @RequestParam(required = false) String textOffset) throws RuleginException {
        try {
    ...
    @ResponseBody
    public List<RuleMetaData> getRules() throws RuleginException {
        try {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void deleteRule(@PathVariable("ruleId") String strRuleId) throws RuleginException {
        checkParameter("ruleId", strRuleId);
        try {
            RuleId ruleId = new RuleId(toUUID(strRuleId));
            RuleMetaData rule = checkRule(ruleService.findRuleById(ruleId));
