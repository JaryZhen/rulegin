...
public class PluginController extends BaseController {
    ...
    @ResponseBody
    public PluginMetaData getPluginById(@PathVariable("pluginId") String strPluginId) throws RuleginException {
    ...
    @ResponseBody
    public PluginMetaData getPluginByToken(@PathVariable("pluginToken") String pluginToken) throws RuleginException {
    ...
    @ResponseBody
    public PluginMetaData savePlugin(@RequestBody PluginMetaData source) throws RuleginException {
    ...
    public void activatePluginById(@PathVariable("pluginId") String strPluginId) throws RuleginException {
        checkParameter("pluginId", strPluginId);
        try {
            PluginId pluginId = new PluginId(toUUID(strPluginId));
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void suspendPluginById(@PathVariable("pluginId") String strPluginId) throws RuleginException {
        checkParameter("pluginId", strPluginId);
        try {
            PluginId pluginId = new PluginId(toUUID(strPluginId));
            PluginMetaData plugin = (pluginService.findPluginById(pluginId));
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void deletePlugin(@PathVariable("pluginId") String strPluginId) throws RuleginException {
        checkParameter("pluginId", strPluginId);
        try {
            PluginId pluginId = new PluginId(toUUID(strPluginId));
            PluginMetaData plugin = (pluginService.findPluginById(pluginId));
